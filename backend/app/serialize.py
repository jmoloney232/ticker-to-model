...
PLAIN_LABELS = {
    ...
    "dep_pct_beginning_ppe": "Depreciation (% of opening PP&E)",
    "amort_pct_beginning_intangibles": "Intangible amortization (% of opening intangibles)",
    "da_pct_revenue": "D&A (% of revenue; PP&E unmapped)",
