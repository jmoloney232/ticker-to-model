...
def golden_dict(m) -> dict:
    ...
    return {
        ...
        "epv_margin": m.assumptions.eff("epv_margin"),
        "ev_epv": m.bridges["epv"].enterprise_value,
        "per_share_epv": m.bridges["epv"].value_per_share,
        "growth_per_share": m.growth.per_share,
        "growth_share_of_dcf": m.growth.share_of_dcf,
